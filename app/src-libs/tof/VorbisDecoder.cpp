...
static void setInstance(JNIEnv * env,jobject object,VorbisDecoder * instance) {
	env->SetIntField(object,gNativeInstanceFieldID,(int)(size_t)instance);
}

extern "C" void
Java_app_tapsoffire_player_VorbisDecoder_nativeStaticSetup(JNIEnv * env) {
	jclass clazz=env->FindClass("app/tapsoffire/player/VorbisDecoder");
    gNativeInstanceFieldID=env->GetFieldID(clazz,"m_nativeInstance","I");
}

extern "C" void
Java_app_tapsoffire_player_VorbisDecoder_nativeClose(JNIEnv * env,jobject thiz) {
...
extern "C" jint
Java_app_tapsoffire_player_VorbisDecoder_nativeOpen(JNIEnv * env,jobject thiz,jstring pathString) {
	Java_app_tapsoffire_player_VorbisDecoder_nativeClose(env,thiz);
...
extern "C" jboolean
Java_app_tapsoffire_player_VorbisDecoder_nativeIsSeekable(JNIEnv * env,jobject thiz) {
	VorbisDecoder * decoder=getInstance(env,thiz);
	if (!decoder) {
		return JNI_FALSE;
	}
...
extern "C" jint
Java_app_tapsoffire_player_VorbisDecoder_nativeGetRate(JNIEnv * env,jobject thiz) {
	VorbisDecoder * decoder=getInstance(env,thiz);
	if (!decoder) {
		return 0;
	}
...
extern "C" jint
Java_app_tapsoffire_player_VorbisDecoder_nativeGetChannels(JNIEnv * env,jobject thiz) {
	VorbisDecoder * decoder=getInstance(env,thiz);
	if (!decoder) {
		return 0;
	}
...
extern "C" jint
Java_app_tapsoffire_player_VorbisDecoder_nativeGetTimeLength(JNIEnv * env,jobject thiz) {
	VorbisDecoder * decoder=getInstance(env,thiz);
	if (!decoder) {
		return 0;
	}
...
extern "C" jint
Java_app_tapsoffire_player_VorbisDecoder_nativeGetTimePosition(JNIEnv * env,jobject thiz) {
	VorbisDecoder * decoder=getInstance(env,thiz);
	if (!decoder) {
		return 0;
	}
...
extern "C" jint
Java_app_tapsoffire_player_VorbisDecoder_nativeSeekToTime(JNIEnv * env,jobject thiz,jint time) {
	VorbisDecoder * decoder=getInstance(env,thiz);
	if (!decoder) {
		return OV_FALSE;
	}
...
extern "C" jint
Java_app_tapsoffire_player_VorbisDecoder_nativeRead(JNIEnv * env,jobject thiz,jbyteArray bufferArray,jint offset,jint length) {
	VorbisDecoder * decoder=getInstance(env,thiz);
	if (!decoder) {
		return 0;
	}
